package com.test.ticketGeneration.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = { "com.test.ticketGeneration.repository" })
public class DatabaseConfig {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("dataSource") DataSource dataSource) {
        return builder.dataSource(dataSource).packages("com.test.ticketGeneration.entities").persistenceUnit("mySqlUnit").build();
    }
